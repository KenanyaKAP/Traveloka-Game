...
bg_layer1.src = "img/Yogyakarta_Layer_1.png";
const bg_layer2 = new Image();
bg_layer2.src = "img/Yogyakarta_Layer_2.png";
const bg_layer3 = new Image();
bg_layer3.src = "img/Yogyakarta_Layer_3.png";
...
class Birdy extends Enemy{
    ...
    draw(){
        ...
        // ctx.strokeRect(this._x+20,this._y+20,this.hitbox.width,this.hitbox.height);
    }
    update(){
        super.update();
...
class EnemyPlane extends Enemy{
    ...
    draw(){
        ctx.drawImage(this.image,this._x, this._y, this.width, this.height);
        // ctx.strokeRect(this._x+5,this._y+40,this.hitbox.width,this.hitbox.height);
    }
    update(){
        super.update();
        this.hitbox.x -=this.speed;
...
class Cloud extends Enemy{
    ...
    draw(){
        ctx.drawImage(this.image,this._x, this._y, this.width, this.height);
        // ctx.strokeRect(this._x+40,this._y+3,this.hitbox.width,this.hitbox.height);
    }
    update(){
        super.update();
        this.hitbox.x -=this.speed;
...
class Kite extends Enemy{
    ...
    draw(){
        ctx.drawImage(this.image,this._x, this._y, this.width, this.height);
        // ctx.strokeRect(this._x,this._y,this.hitbox.width,this.hitbox.height);
    }
    update(){
        super.update();
        this.hitbox.x -=this.speed;
...
const layer1 = new Background(0,0,bg_layer1,bg_layer1,2,1920,canvas.height);
const layer2 = new Background(0,canvas.height-400,bg_layer3,bg_layer3,1,1080,400);
const layer3 = new Background(0,canvas.height-400,bg_layer2,bg_layer2,0.5,1080,400);
const Backgrounds = [layer1, layer3, layer2];
